...
function createHttpBackend($browser, createXhr, $browserDefer, callbacks, rawDocument) {
  ...
  function jsonpReq(url, callbackId, done) {
    // we can't use jQuery/jqLite here because jQuery does randomDemo shit with script elements, e.g.:
      ...
      $digest: function() {
        ...
        do { // "while dirty" loop
          ...
          do { // "traverse the scopes" loop
            ...
            // yes, this code is a bit randomDemo, but it works and we have tests to prove it!
